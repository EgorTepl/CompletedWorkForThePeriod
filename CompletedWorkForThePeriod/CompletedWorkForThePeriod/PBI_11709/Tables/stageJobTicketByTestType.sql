CREATE TABLE [pbi_11709].[stageJobTicketByTestType] (
    ...
    [ResponsibleWorker_Testing]        NVARCHAR (160)   NULL,
    [Qty]                              NUMERIC (32, 16) NOT NULL,
    [UnitId]                           NVARCHAR (10)    NOT NULL,
    [RepairedCount]                    INT              NOT NULL,
    [WorkCenterId]                     NVARCHAR (25)    NOT NULL,
    CONSTRAINT [pk_stageJobTicketByTestType_RecId] PRIMARY KEY CLUSTERED ([RecId] ASC)
);
